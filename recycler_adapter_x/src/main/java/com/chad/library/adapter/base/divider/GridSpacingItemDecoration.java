package com.chad.library.adapter.base.divider;
...
public class GridSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridSpacingItemDecoration(int spacing, int color) {
        this.spacing = spacing;
        this.isIncludeEdge = false;
        this.vertivalSpacing = spacing;
    ...
    public GridSpacingItemDecoration(int spacing, boolean isIncludeEdge) {
        this.spacing = spacing;
        this.isIncludeEdge = isIncludeEdge;
        this.vertivalSpacing = spacing;
    }

    public GridSpacingItemDecoration(int spacing, int vertivalSpacing, boolean isIncludeEdge) {
        this.spacing = spacing;
        this.isIncludeEdge = isIncludeEdge;
        this.vertivalSpacing = vertivalSpacing;
    }

    public GridSpacingItemDecoration(int spacing, int vertivalSpacing, int color, boolean isIncludeEdge) {
        this.spacing = spacing;
        this.isIncludeEdge = isIncludeEdge;
        this.vertivalSpacing = vertivalSpacing;
        this.mDivider = new ColorDrawable(color);
