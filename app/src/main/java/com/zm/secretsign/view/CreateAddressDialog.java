 ...
 *
 */
public class CreateAddressDialog extends Dialog {
...
//    ImageView ivAddress;
    ...
    public CreateAddressDialog(@NonNull Context context, String privateKey, String address, boolean isVerify) {
        this(context, privateKey, address);
        this.isVerify = isVerify;
    }

    public CreateAddressDialog(@NonNull Context context, String privateKey, String address) {
...
//                LogUtil.e("公钥:" + value);
//                ivAddress.setImageBitmap(BarcodeUtil.createQrcodeBitmap(value, dp));
//            }
//
//            @Override
...
//        });
    ...
    private CreateAddressDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
        setContentView(R.layout.dialog_key_copy);
