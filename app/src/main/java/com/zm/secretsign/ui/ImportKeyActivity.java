...
import com.zm.secretsign.ui.fragment.CodeScanFragment;
import com.zm.secretsign.ui.fragment.KeyInputFragment;
import com.zm.secretsign.ui.fragment.MemoryWordFragment;
...
public class ImportKeyActivity extends BaseTitleActivity {
    ...
    private Integer[] titles = {
            R.string.manual_input,
            R.string.import_memory_word,
    ...
    protected void onInit(@Nullable Bundle savedInstanceState) {
        ...
        setUpTextLeftBackIcon(R.string.import_key);
        setDownTextRightIcon();

        fragments = new ArrayList<>();
        fragments.add(KeyInputFragment.newInstance());
        fragments.add(MemoryWordFragment.newInstance());
        fragments.add(CodeScanFragment.newInstance());
